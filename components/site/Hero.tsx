...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div aria-hidden className="absolute inset-x-0 bottom-0 -z-10 h-3/4 bg-gradient-to-t from-ink/75 via-ink/30 to-transparent" />
      <div aria-hidden className="absolute inset-x-0 top-0 -z-10 h-40 bg-gradient-to-b from-ink/40 to-transparent" />
      ...
      <motion.div style={{ y: contentY, opacity: fade }} className="container-page mt-auto pb-8 md:pb-12">
        <motion.p
        ...
        <div className="mt-6 grid items-end gap-10 lg:grid-cols-12">
          ...
          >
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              <ButtonLink href="#apartments" variant="inverse" size="lg" arrow="right">
                Explore apartments
              </ButtonLink>
        ...
        >
          <p className="flex items-center gap-3">
            ...
            <span className="hidden sm:inline">1°56′ S · 30°03′ E</span>
          </p>
          <a href="#apartments" className="group flex items-center gap-3">
            <span className="hidden sm:inline">Scroll to explore</span>
            <span aria-hidden className="relative block h-8 w-px overflow-hidden bg-white/25">
